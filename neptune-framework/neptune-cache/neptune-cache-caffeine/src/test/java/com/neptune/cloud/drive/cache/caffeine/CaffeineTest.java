package com.neptune.cloud.drive.cache.caffeine;

import com.neptune.cloud.drive.cache.caffeine.test.CacheAnnotationTest;
import com.neptune.cloud.drive.cache.caffeine.test.config.CaffeineCacheConfig;
...
public class CaffeineTest {
    ...
    public void caffeineCacheTest() {
        for (int index = 0; index < 2; index++) {
            cacheAnnotationTest.caffeineCache("fuyusakaiori");
        }
    }
