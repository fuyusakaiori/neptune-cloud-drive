package com.neptune.cloud.drive.cache.caffeine.test;
...
public class CacheAnnotationTest {
    ...
    public String caffeineCache(String name) {
        StringBuilder value = new StringBuilder().
                append("hello").append(" ").append(name);
        log.info("CaffeineCacheTest caffeineCache: key: {}, value: {}", name, value);
